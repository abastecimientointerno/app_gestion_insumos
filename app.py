...
#Cobertura
# Evitamos divisiones por cero reemplazando stock_cobertura_ideal por 1 donde sea 0 para evitar errores
...
df_resultado = df_resultado[['id_localidad','id_insumo','nombre_insumo','stock_libre_mas_calidad_general','stock_cobertura_ideal','excedentes','faltantes','cobertura_teorica_con_stock_general','cobertura_teorica_con_stock_general_hub','cobertura_teorica_con_stock_general_hub_transito','cobertura_teorica_con_stock_general_hub_transito_produccion','consumo_diario','dias_de_pesca','ratio_nominal','cip','rendimiento','cobertura_ideal','maxima_descarga','id_localidad_insumo','Cantidad','id_final','valor_redondeo','cobertura_real_general','cobertura_real_general_hub','cobertura_real_general_hub_transito','cobertura_real_general_hub_transito_produccion']]
